...
class Cheque_RegisterAdmin(admin.ModelAdmin):
    list_display = ['entry_no','date','agency_name','purchase_detail','bill_no','cheque_no','cheque_date','amount','paying_amount']      

@admin.register(Bill_Book)
class Bill_BookAdmin(admin.ModelAdmin):
    list_display = ['entry_no','bill_from','date','bill_voucher','bill_amount','payable_amount']      
